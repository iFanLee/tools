...
type unicastIOS struct {
	...
	Policy unicastPolicyIOS `json:"policy"`
	ProductionMode string `json:"production_mode"`
	Description string `json:"description"`
}
//type unicastPayloadIOS struct {
//	Aps unicastPayloadApsIOS `json:"aps"`
//}
type unicastPayloadApsIOS struct {
	Alert unicastPayloadApsAlertIOS `json:"alert"`
	Badge string `json:"badge"`
	Sound string `json:"sound"`
	ContentAvailable int `json:"content-available"`
	Category string `json:"category"`
}
type unicastPayloadApsAlertIOS struct {
	Title string `json:"title"`
	Subtitle string `json:"subtitle"`
	Body string `json:"body"`
}
type unicastPolicyIOS struct {
...
*/
func UnicastJSONByIOS(deviceToken,apsTitle,apsSubtitle,apsBody string,payloadData map[string]interface{},desc string) string  {
	filter := make(map[string]interface{})
	policy := unicastPolicyIOS{
		StartTime:      "",
		ExpireTime:     "",
		OutBizNo:       "",
		ApnsCollapseId: "",
	...
	alert := unicastPayloadApsAlertIOS{
		Title:    apsTitle,
		Subtitle: apsSubtitle,
		Body:     apsBody,
	}
	payload["aps"] = unicastPayloadApsIOS{
		Alert:            alert,
		Badge:            "",
		Sound:            "",
		ContentAvailable: 1,
